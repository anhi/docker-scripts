...
if __name__ == "__main__":
    ...
    if os.path.exists('/export/'):
        change_path('/ballaxy/universe_wsgi.ini')
        change_path('/ballaxy/database/files/')
        change_path('/ballaxy/database/job_working_directory/')
        change_path('/ballaxy/tool_deps/')
        change_path('/shed_tools/')
        change_path('/ballaxy/job_conf.xml')
        change_path('/ballaxy/shed_tool_conf.xml')
        change_path('/ballaxy/integrated_tool_panel.xml')
